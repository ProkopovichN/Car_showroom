...
class RecycleAdapter(private val ListReciepe : ArrayList<Car_info_data>, val listener : Listener) : RecyclerView.Adapter<RecycleAdapter.ItemHolder>() {

    class ItemHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        val binding = ItemCarBinding.bind(itemView)
